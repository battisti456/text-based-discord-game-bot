...
from game.components.send import Sendable
...
class Interaction(object):
    ...
    each interaction follows a designated InteractionType, but it is up to the implementation to actually store the relevant data
    """
    def __init__(
            self,
    ...
    def reply(self,content:str) -> Sendable:
        return Old_Message(
            text = content,
            on_channel=self.channel_id,
            reference_message=self.interaction_id
        )
